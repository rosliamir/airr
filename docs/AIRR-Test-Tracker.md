...
| `tests/Feature/KnowledgeBaseTest.php` | FR-M3.1/M3.2/M3.2a/M3.6 — CRUD, gate, ingest→chunks, **category + other-label + categories endpoint**, unsupported type, reindex, cascade | 9 | ✅ | 2026-06-25 |
